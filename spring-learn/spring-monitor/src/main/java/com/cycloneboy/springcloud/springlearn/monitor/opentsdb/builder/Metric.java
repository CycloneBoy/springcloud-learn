 ...
 */
package com.cycloneboy.springcloud.springlearn.monitor.opentsdb.builder;
...
/**
 * A metric contains measurements or data points. Each data point has a time stamp of when the
 * measurement occurred and a value that is either a long or double and optionally contains tags.
 * Tags are labels that can be added to better identify the metric. For example, if the measurement
 * was done on server1 then you might add a tag named "host" with a value of "server1". Note that a
