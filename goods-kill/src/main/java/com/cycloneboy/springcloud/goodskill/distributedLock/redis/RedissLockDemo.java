...
/**
 * Create by  sl on 2019-12-13 18:35
 */
public class RedissLockDemo {

  public static final String LOCK_NAME = "testLock";
...
//	    Future<Boolean> res = fairLock.tryLockAsync(100, 10, TimeUnit.SECONDS);
  ...
  public void testMultiLock(RedissonClient redisson1, RedissonClient redisson2,
    ...
    RLock lock1 = redisson1.getFairLock("lock1");
    RLock lock2 = redisson2.getFairLock("lock2");
    RLock lock3 = redisson3.getFairLock("lock3");
